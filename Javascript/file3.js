/*
 =========================================Notes================================================
    ...
    Javascript me hum string print karane k liye single quote, double quote or backtiks ka use kar
    sakte he.
...
// console.log('Use single quote without semicolon ;')
// console.log(`My Nick name is  ${myName}. and my hobby is ${myHobby}`);
...
// console.log(typeof firstName, firstName);        //check type of firstName. It is string type of variable

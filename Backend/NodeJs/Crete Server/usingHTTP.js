...
HTTP Module
    ...
    By default browser get request karta he.
    ...
    URL
        It is stand for Uniform Resource Locator
        EX: https://www.faizan.dev/
        ...
        HTTP Methods:
            GET: Want to get data from the server
            POST: Want to send and mutate some data in server
            PUT
            PATCH
            DELETE
